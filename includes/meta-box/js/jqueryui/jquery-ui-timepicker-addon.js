...
(function (e) {
  ...
  e.extend(m.prototype,
    {
      ...
      _newInst: function (c, a) {
        ...
        if (b._defaults.timezoneList === null) {
          d = [];
          for (f = -11; f <= 12; f++) {
            d.push((f >= 0 ? "+" : "-") + ("0" + Math.abs(f).toString()).slice(-2) + "00");
          }
        ...
        b.$input = c;
        if (a.altField) {
          b.$altInput = e(a.altField).css({cursor: "pointer"}).focus(function () {
            c.trigger("focus")
          });
        }
        if (b._defaults.minDate == 0 || b._defaults.minDateTime == 0) {
          b._defaults.minDate = new Date;
        }
        if (b._defaults.maxDate == 0 || b._defaults.maxDateTime == 0) {
          b._defaults.maxDate = new Date;
        }
        if (b._defaults.minDate !== void 0 && b._defaults.minDate instanceof Date) {
          b._defaults.minDateTime = new Date(b._defaults.minDate.getTime());
        }
        if (b._defaults.minDateTime !== void 0 && b._defaults.minDateTime instanceof Date) {
          b._defaults.minDate = new Date(b._defaults.minDateTime.getTime());
        }
        if (b._defaults.maxDate !== void 0 && b._defaults.maxDate instanceof Date) {
          b._defaults.maxDateTime = new Date(b._defaults.maxDate.getTime());
        }
        if (b._defaults.maxDateTime !== void 0 && b._defaults.maxDateTime instanceof Date) {
          b._defaults.maxDate = new Date(b._defaults.maxDateTime.getTime());
        }
        return b
      },
      ...
      _parseTime: function (c, a) {
        var b = this._defaults.timeFormat.toString().replace(/h{1,2}/ig, "(\\d?\\d)").replace(/m{1,2}/ig, "(\\d?\\d)").replace(/s{1,2}/ig, "(\\d?\\d)").replace(/l{1}/ig, "(\\d?\\d?\\d)").replace(/t{1,2}/ig, this._getPatternAmpm()).replace(/z{1}/ig, "(z|[-+]\\d\\d:?\\d\\d)?").replace(/\s/g, "\\s?") + this._defaults.timeSuffix + "$", d = this._getFormatPositions(),
          f = "";
        if (!this.inst) {
          this.inst = e.datepicker._getInst(this.$input[0]);
        }
        ...
        if (b = c.match(RegExp(b, "i"))) {
          if (d.t !== -1) {
            b[d.t] === void 0 || b[d.t].length === 0 ? this.ampm = f = "" : (f = e.inArray(b[d.t].toUpperCase(), this.amNames) !== -1 ? "AM" : "PM", this.ampm = this._defaults[f == "AM" ? "amNames" : "pmNames"][0]);
          }
          if (d.h !== -1) {
            this.hour = f == "AM" && b[d.h] == "12" ? 0 : f == "PM" &&
            b[d.h] != "12" ? (parseFloat(b[d.h]) + 12).toFixed(0) : Number(b[d.h]);
          }
          if (d.m !== -1) {
            this.minute = Number(b[d.m]);
          }
          if (d.s !== -1) {
            this.second = Number(b[d.s]);
          }
          if (d.l !== -1) {
            this.millisec = Number(b[d.l]);
          }
      ...
      _getFormatPositions: function () {
        var c = this._defaults.timeFormat.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|t{1,2}|z)/g), a = {
          h: -1,
          m: -1,
          s: -1,
          l: -1,
        ...
        if (c) {
          for (var b = 0; b < c.length; b++) {
            a[c[b].toString().charAt(0)] == -1 && (a[c[b].toString().charAt(0)] = b + 1);
          }
        }
        return a
      },
      _injectTimePicker: function () {
        ...
        if (c.find("div#ui-timepicker-div-" + h).length === 0 && a.showTimepicker) {
          ...
          if (a.showHour && a.hourGrid > 0) {
            ...
            i += '<dd class="ui_tpicker_hour" id="ui_tpicker_hour_' + h + '"' + (a.showHour ? "" : ' style="display:none;"') + "></dd>";
          }
          ...
          if (a.showMinute && a.minuteGrid > 0) {
            ...
            for (k = a.minuteMin; k <= f; k += parseInt(a.minuteGrid, 10)) {
              r++, i += "<td>" + (k < 10 ? "0" : "") + k + "</td>";
            }
            i += "</tr></table></div></dd>"
          }
          else {
            i += '<dd class="ui_tpicker_minute" id="ui_tpicker_minute_' +
          ...
          if (a.showSecond && a.secondGrid > 0) {
            ...
            for (var p = a.secondMin; p <= g; p += parseInt(a.secondGrid, 10)) {
              m++, i += "<td>" +
                (p < 10 ? "0" : "") + p + "</td>";
            }
            i += "</tr></table></div></dd>"
            ...
            i += '<dd class="ui_tpicker_second" id="ui_tpicker_second_' + h + '"' + (a.showSecond ? "" : ' style="display:none;"') + "></dd>";
          }
          ...
          if (a.showMillisec && a.millisecGrid > 0) {
            ...
            for (k = a.millisecMin; k <= j; k += parseInt(a.millisecGrid, 10)) {
              s++, i += "<td>" + (k < 10 ? "0" : "") + p + "</td>";
            }
            i += "</tr></table></div></dd>"
          }
          else {
            i += '<dd class="ui_tpicker_millisec" id="ui_tpicker_millisec_' + h + '"' + (a.showMillisec ? "" : ' style="display:none;"') + "></dd>";
          }
          ...
          this.millisec_slider =
            $tp.find("#ui_tpicker_millisec_" + h).slider({
              orientation: "horizontal",
              value: this.millisec,
              min: a.millisecMin,
              max: j,
          ...
          a.showHour && a.hourGrid > 0 && (l = 100 * q * a.hourGrid / (d - a.hourMin), $tp.find(".ui_tpicker_hour table").css({
            width: l + "%",
            marginLeft: l / (-2 * q) + "%",
            ...
            e(this).click(function () {
              var c = e(this).html();
              if (a.ampm) {
                var d = c.substring(2).toLowerCase(), c = parseInt(c.substring(0, 2), 10), c = d == "a" ? c == 12 ? 0 : c : c == 12 ? 12 : c + 12;
              }
          ...
          a.showMinute && a.minuteGrid > 0 && (l = 100 * r * a.minuteGrid / (f - a.minuteMin), $tp.find(".ui_tpicker_minute table").css({
            width: l + "%",
            marginLeft: l / (-2 * r) + "%",
            borderCollapse: "collapse"
          }).find("td").each(function () {
            e(this).click(function () {
              ...
              cursor: "pointer", width: 100 / r + "%", textAlign: "center",
              overflow: "hidden"
            })
          }));
          a.showSecond && a.secondGrid > 0 && $tp.find(".ui_tpicker_second table").css({
            width: l + "%",
            marginLeft: l / (-2 * m) + "%",
            borderCollapse: "collapse"
          }).find("td").each(function () {
          ...
          a.showMillisec && a.millisecGrid > 0 && $tp.find(".ui_tpicker_millisec table").css({
            width: l + "%", marginLeft: l / (-2 * s) + "%",
            borderCollapse: "collapse"
          }).find("td").each(function () {
            e(this).click(function () {
          ...
          if (this.inst !== null) {
            c = this.timeDefined, this._onTimeChange(), this.timeDefined = c;
          }
          c = function () {
            b._onSelectHandler()
          };
        ...
        if (this._defaults.showTimepicker) {
          if (e.datepicker._get(c, "minDateTime") !== null && e.datepicker._get(c, "minDateTime") !== void 0 && d) {
            ...
            if (this.hourMinOriginal === null || this.minuteMinOriginal ===
              null || this.secondMinOriginal === null || this.millisecMinOriginal === null) {
              this.hourMinOriginal = b.hourMin, this.minuteMinOriginal = b.minuteMin, this.secondMinOriginal = b.secondMin, this.millisecMinOriginal = b.millisecMin;
            }
            if (c.settings.timeOnly || g.getTime() == d.getTime()) {
              if (this._defaults.hourMin = f.getHours(), this.hour <= this._defaults.hourMin) {
                if (this.hour = this._defaults.hourMin, this._defaults.minuteMin = f.getMinutes(), this.minute <= this._defaults.minuteMin) {
                  this.minute = this._defaults.minuteMin, this._defaults.secondMin =
                    f.getSeconds();
                }
                else {
                  if (this.second <= this._defaults.secondMin) {
                    this.second = this._defaults.secondMin, this._defaults.millisecMin = f.getMilliseconds();
                  }
                  else {
                ...
                this._defaults.minuteMin = this.minuteMinOriginal, this._defaults.secondMin = this.secondMinOriginal, this._defaults.millisecMin = this.millisecMinOriginal;
              }
            }
            else {
              this._defaults.hourMin = this.hourMinOriginal, this._defaults.minuteMin =
          ...
          if (e.datepicker._get(c, "maxDateTime") !== null && e.datepicker._get(c, "maxDateTime") !== void 0 && d) {
            ...
            if (this.hourMaxOriginal === null || this.minuteMaxOriginal === null || this.secondMaxOriginal === null) {
              this.hourMaxOriginal = b.hourMax, this.minuteMaxOriginal = b.minuteMax, this.secondMaxOriginal = b.secondMax,
                this.millisecMaxOriginal = b.millisecMax;
            }
            if (c.settings.timeOnly || g.getTime() == d.getTime()) {
              if (this._defaults.hourMax = f.getHours(), this.hour >= this._defaults.hourMax) {
                if (this.hour = this._defaults.hourMax, this._defaults.minuteMax = f.getMinutes(), this.minute >= this._defaults.minuteMax) {
                  this.minute = this._defaults.minuteMax, this._defaults.secondMax = f.getSeconds();
                }
                else {
                  if (this.second >= this._defaults.secondMax) {
                    this.second = this._defaults.secondMax, this._defaults.millisecMax = f.getMilliseconds();
                  }
                  else {
                    if (this.millisec >
                ...
                this._defaults.minuteMax = this.minuteMaxOriginal, this._defaults.secondMax = this.secondMaxOriginal, this._defaults.millisecMax = this.millisecMaxOriginal;
              }
            }
            else {
              this._defaults.hourMax = this.hourMaxOriginal, this._defaults.minuteMax = this.minuteMaxOriginal, this._defaults.secondMax = this.secondMaxOriginal, this._defaults.millisecMax = this.millisecMaxOriginal
            }
          }
          a !== void 0 && a === true && (b = (this._defaults.hourMax -
          (this._defaults.hourMax - this._defaults.hourMin) % this._defaults.stepHour).toFixed(0), d = (this._defaults.minuteMax - (this._defaults.minuteMax - this._defaults.minuteMin) % this._defaults.stepMinute).toFixed(0), f = (this._defaults.secondMax - (this._defaults.secondMax - this._defaults.secondMin) % this._defaults.stepSecond).toFixed(0), g = (this._defaults.millisecMax - (this._defaults.millisecMax - this._defaults.millisecMin) % this._defaults.stepMillisec).toFixed(0), this.hour_slider && this.hour_slider.slider("option", {
      ...
      _formatTime: function (c, a, b) {
        ...
        var c = c || {
          ...
          }, d = (a || this._defaults.timeFormat).toString(), f = parseInt(c.hour, 10);
  ...
  e.datepicker._updateDatepicker = function (c) {
    ...
    if (!e.datepicker._curInst || !(e.datepicker._curInst != c && e.datepicker._datepickerShowing && e.datepicker._lastInput !=
      ...
      if (typeof c.stay_open !== "boolean" || c.stay_open === false) {
        this._base_updateDatepicker(c), (a = this._get(c, "timepicker")) && a._addTimePicker(c)
      }
    }
  };
  ...
  e.datepicker._disableTimepickerDatepicker = function (c) {
    ...
    if (b) {
      b._defaults.showTimepicker = false, b._updateDateTime(a)
    }
  };
  e.datepicker._enableTimepickerDatepicker = function (c) {
    ...
    e(c).datepicker("getDate");
    if (b) {
      b._defaults.showTimepicker = true, b._addTimePicker(a), b._updateDateTime(a)
    }
  };
  e.datepicker._setTime = function (c, a) {
    ...
    if (b) {
      ...
      if (e < d.hourMin || e > d.hourMax || g < d.minuteMin || g > d.minuteMax || j < d.secondMin || j > d.secondMax || h < d.millisecMin || h > d.millisecMax) {
        e = d.hourMin, g = d.minuteMin,
  ...
  e.datepicker._optionDatepicker = function (c, a, b) {
    ...
    if (d) {
      var e, g, j;
      if (typeof a == "string") {
        a === "minDate" || a === "minDateTime" ? e = b : a === "maxDate" || a === "maxDateTime" ? g = b : a === "onSelect" && (j = b);
      }
      else {
        if (typeof a == "object") {
          if (a.minDate) {
      ...
      if (e) {
        e = e == 0 ? new Date : new Date(e), d._defaults.minDate = e, d._defaults.minDateTime = e;
      }
      else {
        if (g) {
          g = g == 0 ? new Date : new Date(g), d._defaults.maxDate = g, d._defaults.maxDateTime = g;
        }
        else {
          if (j) {
            d._defaults.onSelect = j
          }
        }
      }
    }

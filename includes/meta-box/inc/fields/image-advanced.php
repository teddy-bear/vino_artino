...
if ( ! class_exists( 'RWMB_Image_Advanced_Field' ) ) {
  class RWMB_Image_Advanced_Field extends RWMB_Image_Field {
    ...
    static function admin_enqueue_scripts() {
      ...
      wp_enqueue_media();
      wp_enqueue_script( 'rwmb-image-advanced', RWMB_JS_URL . 'image-advanced.js', array(
        'jquery',
        'underscore'
      ), RWMB_VER, TRUE );
              ...
              <# } else { #>
                ...
                <# } #>
                  <div class="rwmb-image-bar">
                    <a title="<?php echo $i18n_edit; ?>" class="rwmb-edit-file" href="{{{ attachment.editLink }}}"
                       target="_blank"><?php echo $i18n_edit; ?></a> |
                    <a title="<?php echo $i18n_delete; ?>" class="rwmb-delete-file" href="#"
                       data-attachment_id="{{{ attachment.id }}}">&times;</a>
                  </div>
          </li>
          <# } ); #>
      </script>

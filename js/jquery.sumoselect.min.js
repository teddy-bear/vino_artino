      ...
      !this.sumo && e(this).is("select") && (this.sumo = {
        ...
        _cnbtn: function () {
          ...
          for (e.E.children("option:selected").each(function () {
            this.selected = !1
          }), e.optDiv.find("li.selected").removeClass("selected"), i = 0; i < e.Pstate.length; i++) {
            e.E.children('option[value="' + e.Pstate[i] + '"]')[0].selected = !0, e.optDiv.find('li[data-val="' + e.Pstate[i] + '"]').addClass("selected");
          }
          e.selAllState()
        },
        selAll: function () {
        ...
        showOpts: function () {
          var t = this;
          t.E.attr("disabled") || (t.is_opened = !0, t.optDiv.addClass("open"), t.is_floating && (H = t.optDiv.children("ul").outerHeight() + 2, t.is_multi && (H += parseInt(t.optDiv.css("padding-bottom"))), t.optDiv.css("height", H)), t.is_multi && (t.is_floating || l.okCancelInMulti) && (t.Pstate = [], t.E.children("option:selected").each(function () {
            t.Pstate.push(e(this).val())
          })))
        },
        hideOpts: function () {
          var e = this;
          e.is_opened = !1, e.optDiv.removeClass("open").find("ul li.sel").removeClass("sel")
        },
        setOnOpen: function () {
          var e = this, t = e.optDiv.find("ul li").eq(e.E[0].selectedIndex);
          t.addClass("sel"), e.showOpts()
        },
        nav: function (e) {
          var t, l = this, i = l.optDiv.find("ul li.sel");
          if (l.is_opened && i.length) {
            if (t = e ? i.prevAll("li:not(.disabled)") : i.nextAll("li:not(.disabled)"), !t.length) {
              return;
            }
            i.removeClass("sel"), i = t.first().addClass("sel");
            var s = l.optDiv.find("ul"), n = s.scrollTop(), o = i.position().top + n;
        ...
        basicEvents: function () {
          ...
          t.CaptionCont.click(function (e) {
          ...
          }), t.select.on("blur", function () {
            t.is_opened && (t.hideOpts(), t.is_multi && l.okCancelInMulti && t._cnbtn())
            ...
            switch (e.which) {
              ...
              case 13:
                ...
                break;
              case 27:
                t.is_multi && l.okCancelInMulti && t._cnbtn(), t.hideOpts();
                break;
              default:
                return
            }
        ...
        setText: function () {
          ...
          if (t.placeholder = "", t.is_multi) {
            ...
            t.placeholder = t.E.children(":selected").not(":disabled").text();
          }
        ...
        vRange: function (e) {
          var t = this;
          if (opts = t.E.children("option"), opts.length <= e || 0 > e) {
        ...
        add: function (l, i, s) {
          ...
          var n = this;
          if (opts = n.E.children("option"), "number" == typeof i && (s = i, i = l), "undefined" == typeof i && (i = l), opt = e("<option></option>").val(l).html(i), opts.length < s) {
            throw"index out of bounds";
          }
